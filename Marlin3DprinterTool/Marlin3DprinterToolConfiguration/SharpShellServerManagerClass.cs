    ...
    public static class SharpShellServerManagerClass
    {
        ...
        public static ServerInfo GetServerinfo(ServerEntry serverEntry)
        {
            ...
            ServerInfo serverInfo = new ServerInfo
            {
                ...
                ServerType = serverEntry.ServerType.ToString(),
                ClassId = serverEntry.ClassId.ToString(),
                SecurityStatus = serverEntry.GetSecurityStatus(),
                ServerPath = serverEntry.ServerPath,
                IsInvalid = serverEntry.IsInvalid,
                Association = associationType + " " + string.Join(", ", associations),
                Info32 =
                    SharpShell.ServerRegistration.ServerRegistrationManager.GetServerRegistrationInfo(
                        serverEntry.Server.ServerClsid, RegistrationType.OS32Bit),
                Info64 =
                    SharpShell.ServerRegistration.ServerRegistrationManager.GetServerRegistrationInfo(
                        serverEntry.Server.ServerClsid, RegistrationType.OS64Bit)
            };
